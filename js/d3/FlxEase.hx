...
*/
@:enum abstract EaseType(String){
	var LinearIn = "linear-in";
	var LinearOut = "linear-out";
	var LinearInOut = "linear-in-out";
	var LinearOutIn = "linear-out-in";
	
	var PolyIn = "poly-in";
	var PolyOut = "poly-out";
	var PolyInOut = "poly-in-out";
	var PolyOutIn = "poly-out-in";
	
	var QuadIn = "quad-in";
	var QuadOut = "quad-out";
	var QuadInOut = "quad-in-out";
	var QuadOutIn = "quad-out-in";
	
	var CubicIn = "cubic-in";
	var CubicOut = "cubic-out";
	var CubicInOut = "cubic-in-out";
	var CubicOutIn = "cubic-out-in";
	
	var SinIn = "sin-in";
	var SinOut = "sin-out";
	var SinInOut = "sin-in-out";
	var SinOutIn = "sin-out-in";
	
	var ExpIn = "exp-in";
	var ExpOut = "exp-out";
	var ExpInOut = "exp-in-out";
	var ExpOutIn = "exp-out-in";
	
	var CircleIn = "circle-in";
	var CircleOut = "circle-out";
	var CircleInOut = "circle-in-out";
	var CircleOutIn = "circle-out-in";
	
	var ElasticIn = "elastic-in";
	var ElasticOut = "elastic-out";
	var ElasticInOut = "elastic-in-out";
	var ElasticOutIn = "elastic-out-in";
	
	var BackIn = "back-in";
	var BackOut = "back-out";
	var BackInOut = "back-in-out";
	var BackOutIn = "back-out-in";
	
	var BounceIn = "bounce-in";
	var BounceOut = "bounce-out";
	var BounceInOut = "bounce-in-out";
	var BounceOutIn = "bounce-out-in";
}
